# AgentPack Environment And Configuration
...
PORT=4305
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/agentpack
APP_BASE_URL=http://localhost:4305
...
OBJECT_STORAGE_BUCKET=agentpack-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
