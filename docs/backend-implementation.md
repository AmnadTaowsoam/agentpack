# AgentPack Backend Implementation Specification
...
- Database: File-first JSON/Markdown registry, optional PostgreSQL for hosted catalog.
- Queue: Pack validation and documentation build jobs.
...
- workspace_id
- name
- domain: 'agent and skill template packs'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for agent and skill template packs.
...
- Worker can complete the primary agent and skill template packs workflow using sample inputs.
